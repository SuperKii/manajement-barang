    ...
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0">Upadate Data User</h5>
        ...
        @endif --}}
            <div class="card-body">
                <form action="{{ route('userUpdate',$userEdit->id_user) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name">Nama</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" name="nama"
                                placeholder="Nama" value="{{$userEdit->nama}}"/>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control" id="basic-default-name" name="email"
                                placeholder="Email" value="{{$userEdit->email}}"/>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" name="no_hp"
                                placeholder="No Hp" value="{{$userEdit->no_hp}}"/>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" name="alamat"
                                placeholder="alamat" value="{{$userEdit->alamat}}"/>
                        </div>
                    </div>
                    <div class="row mb-3">
