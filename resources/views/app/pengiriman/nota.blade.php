@extends('main.index')
@section('content')
    <h4 class="fw-bold py-3 mb-4">Nota Pengiriman</h4>
    ...
    <form action="{{ route('pengirimanStore') }}" method="POST">
        @csrf
        <div class="card">
    ...
    @endif --}}
            <div class="card-body">
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="basic-default-name">Tujuan Pengiriman</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="basic-default-name" name="tujuan"
                            placeholder="Tujuan" />
                    </div>
                </div>
